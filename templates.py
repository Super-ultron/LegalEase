...
ALWAYS start generation of the document output inside TAGS '<begin>' and end it with a '<end>' tag.
...
if not enough information , provide the document with blanks filled with tags like <that_info> in  place of that info.
